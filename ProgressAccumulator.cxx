...
void ProgressAccumulator::ManualSet(std::string text, int value, bool calledFromThread)
{
...
void ProgressAccumulator::ManualUpdate(int value, bool calledFromThread)
{
	_progressBar->setValue(value);
	_progressBar->update();
